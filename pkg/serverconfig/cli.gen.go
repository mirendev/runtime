...
type CLIFlags struct {
	...
	WorkloadIdentityConfigAnchor         *string  `long:"identity-anchor" description:"Where workload identity tokens are anchored: cluster (default, this cluster serves its own discovery) or cloud (miren.cloud serves discovery for it). Signing keys stay on the cluster either way." env:"MIREN_WORKLOAD_IDENTITY_ANCHOR"`
}
