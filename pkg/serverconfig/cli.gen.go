...
type CLIFlags struct {
	...
	ServerConfigAddress             *string  `long:"address" short:"a" description:"Address to listen on"`
	...
	ServerConfigRunnerAddress       *string  `long:"runner-address" description:"Runner address"`
