...
//
//	mockgen -package webtransport -destination mock_stream_test.go github.com/quic-go/quic-go/http3 Stream
//
...
func (mr *MockStreamMockRecorder) ReceiveDatagram(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReceiveDatagram", reflect.TypeOf((*MockStream)(nil).ReceiveDatagram), arg0)
}
...
func (mr *MockStreamMockRecorder) SendDatagram(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendDatagram", reflect.TypeOf((*MockStream)(nil).SendDatagram), arg0)
}
