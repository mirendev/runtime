...
// each phase's work is safe to repeat. The list is meant to grow: a
// pre-upgrade backup (RFD-75) is a phase before downloading that records a
// bundle reference, and rollback then restores data as well as the binary.
type Phase string
