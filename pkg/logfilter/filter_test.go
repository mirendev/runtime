...
func TestToLogsQL(t *testing.T) {
	tests := []struct {
		...
		{"punctuation word", `status=500`, `*:"status=500"`},
		{"word with quote", `say"hello`, `*:"say\"hello"`},
		{"word with backslash", `C:\\temp`, `*:"C:\\\\temp"`},
		{"reserved word", `in`, `*:"in"`},
		{"reserved contains any", `contains_any`, `*:"contains_any"`},
		{"reserved contains all", `contains_all`, `*:"contains_all"`},
		{"negated reserved word", `-contains_any`, `-(*:"contains_any")`},
	}
