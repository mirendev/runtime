---
title: "miren server operations"
sidebar_label: "server operations"
description: "Durable server restart and upgrade operations"
---

# miren server operations

Durable server restart and upgrade operations

## Usage

```bash
miren server operations [flags]
```
