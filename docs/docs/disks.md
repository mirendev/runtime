...
They work out of the box on any Linux host. For faster writes, [accelerator mode](./disk-accelerator.md) builds and loads a Miren kernel module tuned for this job; it is one command, and disks fall back to the default cleanly if you skip it.
