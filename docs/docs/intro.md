...
**[Getting Started](./getting-started.md)** walks you through installation, server setup, and deploying your first app in a few minutes.

## Learn more

- [App Configuration](./app-configuration.md) - `.miren/app.toml` and how to configure your app
- [Deployment](./deployment.md) - Deploy workflows, rollbacks, and CI integration
- [Pull Request Environments](./pr-environments.md) - Time-boxed preview deploys, one per PR
- [Services](./services.md) - Run multiple processes (web, workers, databases) in one app
- [Scaling](./scaling.md) - Autoscaling and fixed instance modes
- [Traffic Routing](./traffic-routing.md) - Custom domains, TLS, and path-based routing
- [Disks](./disks.md) - Persistent storage with backup and restore
- [Logs](./logs.md) - Application, build, and system logs
