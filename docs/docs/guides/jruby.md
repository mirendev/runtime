---
title: JRuby on Miren
description: Deploy Ruby on the JVM with JRuby on Miren using a Dockerfile.miren and Sinatra.
keywords: [jruby, ruby, jvm, sinatra, puma, bundler, dockerfile, deploy]
---
...
:::warning[JVM boot vs. the port timeout]
