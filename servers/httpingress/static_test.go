...
func TestServeStaticArtifact(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "directory redirect", method: http.MethodGet, path: "/docs", wantServed: true, wantStatus: http.StatusMovedPermanently, wantBody: "<a href=\"/docs/\">Moved Permanently</a>.\n\n"},
