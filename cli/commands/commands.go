...
func AllCommands() map[string]cli.CommandFactory {
	base := map[string]cli.CommandFactory{
		...
		"app delete": func() (cli.Command, error) {
			return Infer("app delete", "Delete an application", AppDelete), nil
		},

		"app undelete": func() (cli.Command, error) {
			return Infer("app undelete", "Restore a deleted application", AppUndelete), nil
		},
