...
func newNodeStorageBoot(access boot.Output[clusterAccessBootOutput], telemetry boot.Output[telemetryBootOutput]) *nodeStorageBoot {
	b := &nodeStorageBoot{}
	b.component, b.output = boot.Provide2("node-storage", access, telemetry, b.start,
		boot.WithStop(b.stop, 0))
	return b
}

func (b *nodeStorageBoot) start(ctx context.Context, access clusterAccessBootOutput, telemetry telemetryBootOutput) (*runner.NodeStorage, error) {
	var err error
