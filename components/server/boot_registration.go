...
func newRegistrationBoot(inputs registrationBootInputs) *registrationBoot {
	...
	b.component = readiness.NewComponent("registration", readiness.Spec{Start: b.start})
	return b
}

func (b *registrationBoot) output() registrationBootOutput {
	return b.result
}

func (b *registrationBoot) start(context.Context, readiness.Reporter) error {
	...
	b.result.cloudAuth = coordinate.CloudAuthConfig{
		Enabled:           true,
	...
	b.result.anchor = reg.IdentityAnchor
	return nil
}
